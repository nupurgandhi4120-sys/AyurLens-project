# AyurLens: Medicinal Plant Companion

AyurLens is an AI-powered platform developed for the **Bharat Academix CodeQuest Hackathon**[cite: 2]. [cite_start]Its mission is to bridge India’s rich AYUSH heritage with modern AI technology, making traditional botanical knowledge accessible, safe, and interactive for everyone[cite: 6].
...
1. **Open App:** Land on the intuitive, user-friendly homepage[cite: 101, 102].
2. **Scan the Plant:** Use the camera or upload an image to initiate the identification process[cite: 103].
3. **Fetch Live Data:** The AI engine processes the image and retrieves relevant data[cite: 104].
4. **View Results:** Access the plant name and in-depth botanical, safety, and usage details[cite: 105, 106].
...
## ⚠️ Disclaimer
*This application is intended for educational purposes only. Users should consult certified AYUSH practitioners before using any medicinal plants for treatment*

---

**Project Team:** Jensy Savaliya, Nupur Gandhi [cite: 10, 11]
**Live Demo:** [AyurLens](https://willowy-dolphin-30b086.netlify.app) [cite: 176]
**GitHub Repository:** [AyurLens Project](https://github.com/nupurgandhi4120-sys/AyurLens-project) [cite: 177]
